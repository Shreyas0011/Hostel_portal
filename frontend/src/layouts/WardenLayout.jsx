...
import { setWardenTab } from '../redux/dashboard/dashboardSlice';
...
const WardenLayout = ({ children, title, subtitle }) => {
  ...
  const activeTab = useSelector((state) => state.dashboard.wardenActiveTab);
  ...
  const navItems = [
    { id: 'leaves', label: 'Student Absence Logs', icon: ICONS.calendar },
    { id: 'dining', label: 'Dining Acceptance Tracker', icon: ICONS.coffee },
    { id: 'behaviour', label: 'Behaviour Registry', icon: ICONS.clipboard },
    { id: 'complaints', label: 'Student Complaints Desk', icon: ICONS.complaint },
  ];
    ...
    <div className="dashboard-layout">
      ...
      <aside id="dashboard-sidebar" className={`sidebar ${mobileOpen ? 'mobile-open' : ''}`}>
        ...
        <div className="sidebar-profile">
          <div className="profile-avatar" style={{ background: '#7c3aed', color: 'white' }}>W</div>
