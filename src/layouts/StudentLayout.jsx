...
import { setStudentTab } from '../redux/dashboard/dashboardSlice';
...
const StudentLayout = ({ children, title, subtitle }) => {
  ...
  const activeTab = useSelector((state) => state.dashboard.studentActiveTab);
  ...
  const navItems = [
    { id: 'meals', label: 'Mess & Dinings', icon: ICONS.coffee },
    { id: 'leave', label: 'Leave requests', icon: ICONS.calendar },
    { id: 'attendance', label: 'Gate Entry / Exit', icon: ICONS.users },
    { id: 'health', label: 'Medical & Health', icon: ICONS.shield },
    { id: 'behaviour', label: 'Behaviour Observations', icon: ICONS.clipboard },
    { id: 'complaints', label: 'Complaints Desk', icon: ICONS.complaint },
  ];
        ...
        {student && (
          <div className="sidebar-profile">
            ...
            <div className="profile-info">
              ...
              <span className="profile-role">Room {student.room} ({student.block})</span>
            </div>
          </div>
        )}
        ...
        <nav className="sidebar-nav">
          {navItems.map((item) => (
            <button 
              ...
              onClick={() => {
                dispatch(setStudentTab(item.id));
                setMobileOpen(false);
              }}
            >
