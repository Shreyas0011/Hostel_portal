...
import { setAdminTab } from '../redux/dashboard/dashboardSlice';
...
const AdminLayout = ({ children, title, subtitle }) => {
  ...
  const activeTab = useSelector((state) => state.dashboard.adminActiveTab);
  ...
  const navItems = [
    { id: 'menu', label: 'Mess Menu Config', icon: ICONS.coffee },
    { id: 'leaves', label: 'Student Outings Control', icon: ICONS.calendar },
    { id: 'directory', label: 'Residents Directory', icon: ICONS.users },
  ];
    ...
    <div className="dashboard-layout">
      ...
      <aside id="dashboard-sidebar" className={`sidebar ${mobileOpen ? 'mobile-open' : ''}`}>
        ...
        <div className="sidebar-profile">
          <div className="profile-avatar" style={{ background: '#3b82f6', color: 'white' }}>A</div>
          <div className="profile-info">
            <span className="profile-name">Campus Admin Console</span>
